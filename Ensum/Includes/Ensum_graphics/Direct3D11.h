...
namespace Ensum
{
	namespace Graphics
	{
		...
		class ENSUM_GRAPHICS_EXPORT Direct3D11
		{
		public:
			...
			const void DeleteRenderTarget(RenderTarget &rt)const;
			...
			const void DeleteDepthBuffer(DepthBuffer &db)const;
			...
			const void DeleteStructuredBuffer(StructuredBuffer &sb)const;

			IndirectArgsBuffer CreateIndirectArgsBuffer(
				unsigned size,
				void *initialData = nullptr
				)const;
			const void DeleteIndirectArgsBuffer(IndirectArgsBuffer &iab)const;
